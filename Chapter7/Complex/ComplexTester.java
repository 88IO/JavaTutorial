class ComplexTester {
    public static void main(String[] args) {
        Complex complex = new Complex(0.0, 2.0);
        ...
        System.out.println("Description: " + addComplex.description());

        Complex subComplex = new Complex(3.0, 1.0);
        subComplex.sub(complex);
        System.out.println("Description: " + subComplex.description());

        Complex mulComplex = new Complex(3.0, 2.0);
        mulComplex.mul(complex);
        System.out.println("Description: " + mulComplex.description());

        Complex divComplex = new Complex(4.0, 1.0);
        divComplex.div(complex);
        System.out.println("Description: " + divComplex.description());
    }
}
